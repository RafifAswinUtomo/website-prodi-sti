<x-layouts.admin title="Kelas Transfer">
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800">Kelola Kelas Transfer</h2>
    </x-slot>

    <div class="bg-white border rounded-lg p-6 max-w-2xl">
        <form action="{{ route('admin.kelas-transfer.update') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-4">
