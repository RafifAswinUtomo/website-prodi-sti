<x-layouts.admin title="Jadwal UTS dan UAS">
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800">Kelola Jadwal UTS dan UAS</h2>
    </x-slot>

    <div class="bg-white border rounded-lg p-6 max-w-2xl">
        <form action="{{ route('admin.jadwal-uts-uas.update') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-4">
