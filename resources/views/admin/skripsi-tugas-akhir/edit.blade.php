<x-layouts.admin title="Edit Item">
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800">Edit Item Skripsi/Tugas Akhir</h2>
    </x-slot>

    <div class="bg-white border rounded-lg p-6 max-w-2xl">
        <form action="{{ route('admin.skripsi-tugas-akhir.update', $item) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="mb-4">
