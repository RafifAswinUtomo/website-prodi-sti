<x-layouts.admin title="Tambah Data">
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800">Tambah Penalaran, Minat & Bakat</h2>
    </x-slot>
    <div class="bg-white border rounded-lg p-6 max-w-2xl">
        <form action="{{ route('admin.penalaran-minat-bakat.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-4">
