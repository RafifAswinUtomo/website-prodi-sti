<x-layouts.admin title="Wisuda">
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800">Kelola Wisuda</h2>
    </x-slot>

    <div class="bg-white border rounded-lg p-6 max-w-2xl">
        <form action="{{ route('admin.wisuda.update') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-4">
