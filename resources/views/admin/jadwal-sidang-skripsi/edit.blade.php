<x-layouts.admin title="Jadwal Sidang Skripsi">
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800">Kelola Jadwal Sidang Skripsi</h2>
    </x-slot>

    <div class="bg-white border rounded-lg p-6 max-w-2xl">
        <form action="{{ route('admin.jadwal-sidang-skripsi.update') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-4">
